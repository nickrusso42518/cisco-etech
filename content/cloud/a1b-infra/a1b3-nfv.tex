...
\addimg{nfvis-home.png}{0.7}{Cisco NFVIS Home Dashboard}
...
\addimg{nfvis-images.png}{0.7}{Cisco NFVIS Image Repository}
...
\addimg{nfvis-profiles.png}{0.7}{Cisco NFVIS Image Profiles}
...
\addimg{nfvis-logging.png}{0.7}{Cisco NFVIS Topology Builder}
