...
(RFC 4364 Section 10a). The diagram that follows summarizes Viptela at a high level.
    ...
    \begin{minipage}[t]{\linewidth}
	  \centering
      \includegraphics[width=0.7\textwidth]{\imgpath viptela-hl.png}
      \captionof{figure}{Viptela SD-WAN High Level}
    \end{minipage}
...
needing repair.
    ...
    \begin{minipage}[t]{\linewidth}
	  \centering
      \includegraphics[width=0.7\textwidth]{\imgpath viptela-home.png}
      \captionof{figure}{Viptela Home Dashboard}
    \end{minipage}
...
and is a good place to start troubleshooting when issues arise.
    ...
    \begin{minipage}[t]{\linewidth}
	  \centering
      \includegraphics[width=0.7\textwidth]{\imgpath viptela-nodes.png}
      \captionof{figure}{Viptela Node Summary}
    \end{minipage}
...
events and the text details in one screen.
    ...
    \begin{minipage}[t]{\linewidth}
	  \centering
      \includegraphics[width=0.7\textwidth]{\imgpath viptela-events.png}
      \captionof{figure}{Viptela Event Logging}
    \end{minipage}
...
node, which is a physical vEdge-100m appliance.
    ...
    \begin{minipage}[t]{\linewidth}
	  \centering
      \includegraphics[width=0.7\textwidth]{\imgpath viptela-flows.png}
      \captionof{figure}{Viptela Flow Exploration}
    \end{minipage}
...
that its performance is within the SLA's specification.
    ...
    \begin{minipage}[t]{\linewidth}
	  \centering
      \includegraphics[width=0.7\textwidth]{\imgpath viptela-voice-policy.png}
      \captionof{figure}{Viptela VoIP QoS Policy}
    \end{minipage}
...
The diagram below depicts a high level image of the ACI infrastructure provided by Cisco.
    ...
    \begin{minipage}[t]{\linewidth}
	  \centering
      \includegraphics[width=0.7\textwidth]{\imgpath aci-overview.png}
      \captionof{figure}{Cisco ACI SD-DC High Level}
    \end{minipage}
