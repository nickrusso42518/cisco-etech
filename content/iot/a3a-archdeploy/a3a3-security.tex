...
\begin{enumerate}
  ...
  \item AnyConnect: Protects remote devices from threats off-net. NGFW and ISE team up to protect against remote threats and place remote users in the proper groups with proper permissions
\end{enumerate}
}
