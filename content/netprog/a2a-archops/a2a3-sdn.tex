...
\begin{enumerate}
  ...
  several routers each with their own control-plane and no centralization.
    ...
    \begin{minipage}[t]{\linewidth}
	  \centering
      \includegraphics[width=0.7\textwidth]{\imgpath sdn-distributed.jpg}
      \captionof{figure}{SDN Model - Distributed}
    \end{minipage}
  ...
  cases. The diagram that follows depicts the augmented SDN model.
    ...
    \begin{minipage}[t]{\linewidth}
	  \centering
      \includegraphics[width=0.7\textwidth]{\imgpath sdn-augmented.jpg}
      \captionof{figure}{SDN Model - Augmented}
    \end{minipage}
  ...
  depicts the augmented SDN model.
    ...
    \begin{minipage}[t]{\linewidth}
	  \centering
      \includegraphics[width=0.7\textwidth]{\imgpath sdn-hybrid.jpg}
      \captionof{figure}{SDN Model - Augmented}
    \end{minipage}
  ...
  entirely on the controller.
    ...
    \begin{minipage}[t]{\linewidth}
	  \centering
      \includegraphics[width=0.7\textwidth]{\imgpath sdn-centralized.jpg}
      \captionof{figure}{SDN Model - Centralized}
    \end{minipage}
\end{enumerate}
