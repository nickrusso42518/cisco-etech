...
\begin{enumerate}
  ...
  \item	\textbf{Incubated:} Mature the software, migrate to OpenStack after 2 milestones of incubation
...
The command on the following page shows basic information about the public
